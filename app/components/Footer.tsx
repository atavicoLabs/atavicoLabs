      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md mb-4">
              Building digital products end-to-end. From MVP to full-scale platforms, 
              we deliver quality software that scales with your business.
            </p>
            <div className="flex gap-4">
              <a
                href="https://github.com/studiofullstack"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/company/studiofullstack"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-500 transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://twitter.com/studiofullstack"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-500 transition-colors"
                aria-label="Twitter"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:hello@studiofullstack.dev" className="hover:text-blue-500 transition-colors">
              ...
              <li className="pt-2">
                <span className="text-sm">Based in Italy</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} Studio Full Stack. All rights reserved.
          </p>
