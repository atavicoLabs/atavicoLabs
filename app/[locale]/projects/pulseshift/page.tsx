...
export default function PulseShiftProject() {
  const t = useTranslations('projects.pulseshift');
  ...
  return (
    <main className="min-h-screen bg-warm-black">
      ...
      {/* Gallery Section - mobile screens 9:16 aspect */}
      <ProjectSection title={t('gallery.title')} bgColor="bg-warm-darker">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="aspect-[9/16] bg-warm-card border border-warm-border flex items-center justify-center">
