...
export default function EnergyIntelligencePage() {
  const t = useTranslations('projects.energyIntelligence');
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {['Python', 'PyTorch', 'PostgreSQL', 'React', 'D3.js', 'TimeSeries DB'].map((tag) => (
              <span 
                key={tag}
      ...
      <section className="pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="p-6 bg-white/[0.03] border border-grigio/10 rounded-lg">
              <div className="text-sm text-grigio/50 mb-2 font-mono">{t('metrics.facilities.label')}</div>
              <div className="text-2xl text-primary font-light">{t('metrics.facilities.value')}</div>
            </div>
            <div className="p-6 bg-white/[0.03] border border-grigio/10 rounded-lg">
